...
image1 <- image_read(filelist[9])
image_browse(image1)

image_bearb1 <- image_rotate(image1, 0)
image_browse(image_bearb1)#If this particular image needed rotating

image_bearb2 <- image_crop(image_bearb1, geometry_area(width= 1492, height= 2942, x_off = 356, y_off = 342)) #This syntax is quite unclear, but it works like this
...
article.title <- "Who won the elections?"            #Title can be entered manually, or cropped and run through OCR
...
```{r}
text.complete <- paste(text1, text2, text3)
